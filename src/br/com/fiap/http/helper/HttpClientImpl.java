...
{
	private final String CATEGORIA = "handson" ;
	...
	@Override
	public final String doPost( String url, Map<String, Object> map )
	{
		try
		{
			HttpClient httpclient = new DefaultHttpClient( ) ;
	...
	private List<NameValuePair> getParams( Map<String, Object> map ) throws IOException
	{
